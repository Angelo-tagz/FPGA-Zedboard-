...
HD_PWD='C:/Users/Twaga/ECE421/XADC_DMA_FFT/XADC_PS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_PS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source XADC_PS_wrapper.tcl -notrace
