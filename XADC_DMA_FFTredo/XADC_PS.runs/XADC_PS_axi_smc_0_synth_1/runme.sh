...
HD_PWD='C:/Users/Twaga/ECE421/XADC_DMA_FFT/XADC_PS.runs/XADC_PS_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_PS_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XADC_PS_axi_smc_0.tcl
