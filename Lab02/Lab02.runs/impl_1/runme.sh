...
HD_PWD='C:/Users/Twaga/ECE421/Lab02/Lab02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab02_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab02_wrapper.tcl -notrace
