...
HD_PWD='C:/Users/Twaga/ECE421/Lab02/Lab02.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab02_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab02_wrapper.tcl
